...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void) {
			...
			this->start->Text = L"Ղաղալ երկուսով";
			...
			this->train->Text = L"Սկսել ուսուցումը";
			...
			this->train_in_game->Text = L"Սովորացնել";
...
private: System::Void train_Click(System::Object^ sender, System::EventArgs^ e) {
	if (!worker->IsBusy) {
		...
		log->Text = "Проводится урок\n";
		log->Text += "урок еще не окончен!";
	}
}
